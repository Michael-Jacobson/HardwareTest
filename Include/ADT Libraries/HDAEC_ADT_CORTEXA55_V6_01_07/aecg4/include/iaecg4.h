...
ADT_API char *AECG4_ADT_getVersionString();
...
ADT_API void AECG4_ADT_gainBlock(
...
#define AECG4_ADT_ANTI_HOWL_ENABLE 2

#define AECG4_ADT_MAX_AUDIO_FREQ_HZ 4

#define AECG4_ADT_TX_NLP_AGGRESSIVENESS 10
#define AECG4_ADT_MAX_TX_LOSS_ST_DB 11
#define AECG4_ADT_MAX_TX_LOSS_DT_DB 12
#define AECG4_ADT_MAX_RX_LOSS_DB 13

#define AECG4_ADT_RX_SATURATE_LEVEL_DBM 18
#define AECG4_ADT_NOISE_REDUCTION1_SETTING 19
#define AECG4_ADT_NOISE_REDUCTION2_SETTING 20
#define AECG4_ADT_CNG_ENABLE 21
#define AECG4_ADT_FIXED_GAIN_DB10 22
#define AECG4_ADT_TXAGC_ENABLE 23
#define AECG4_ADT_TXAGC_MAX_GAIN_DB 24				
#define AECG4_ADT_TXAGC_MAX_LOSS_DB 25			
#define AECG4_ADT_TXAGC_TARGETPOWER_DBM 26
#define AECG4_ADT_TXAGC_LOW_SIG_THRESHOLD_DBM 27
#define AECG4_ADT_RXAGC_ENABLE 28
#define AECG4_ADT_RXAGC_MAX_GAIN_DB 29				
#define AECG4_ADT_RXAGC_MAX_LOSS_DB 30		
#define AECG4_ADT_RXAGC_TARGETPOWER_DBM 31
#define AECG4_ADT_RXAGC_LOW_SIG_THRESHOLD_DBM 32
#define AECG4_ADT_RX_BYPASS_ENABLE 33

ADT_API XDAS_Int8 AECG4_ADT_getParamValue(IAECG4_Handle handle, ADT_UInt8 ParamID, ADT_Int32 *pValue, char *pStringValue);
ADT_API XDAS_Int8 AECG4_ADT_setParamValue(IAECG4_Handle handle, ADT_UInt8 ParamID, ADT_Int32 Value);

ADT_API XDAS_Int8 AECG4_ADT_getParamValueMMIC(IMMICAECG4_Handle handle, ADT_UInt8 ParamID, ADT_Int32 *pValue, char *pStringValue);
ADT_API XDAS_Int8 AECG4_ADT_setParamValueMMIC(IMMICAECG4_Handle handle, ADT_UInt8 ParamID, ADT_Int32 Value);
