...
#if defined (_54_) || (_55_) || (_28_) || (WIN32) || (IPHONE) || (LINUX) || (__APPLE__)
...
#endif
#if defined (WIN32) || (IPHONE) || (LINUX)  || (__APPLE__)
void *mem_align(size_t alignment, size_t size)
{
    void     **mallocPtr;
    void     **retPtr;
    ...
    retPtr = (void *)(((unsigned long long int)mallocPtr + alignment) & ~(alignment - 1));
#else
