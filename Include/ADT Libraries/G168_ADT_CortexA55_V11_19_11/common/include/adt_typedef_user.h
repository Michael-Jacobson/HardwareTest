...
#if defined(WIN32) || defined(__LP64__)
# ifdef _USRDLL_ADT
#  ifdef __cplusplus
...
# endif
     ...
     #define __arm
      ...
      typedef unsigned __int64    ADT_UInt40;  // 64b
      typedef __int64             ADT_Int64;   // 64b
      typedef unsigned __int64    ADT_UInt64;  // 64b

   #elif defined (LINUX) || defined (LINUX32) || defined(__arm)  || defined(__i386) ||  defined(__arm__) || defined (__APPLE_CC__) || defined(__GNUC__) || defined(__aarch64__)  || defined(__LP64__)   
      typedef int                 ADT_Bool;    //32b
      typedef   signed char       ADT_Int8;    // 8b
      typedef unsigned char       ADT_UInt8;   // 8b
      typedef   signed short int  ADT_Int16;   //16b
      ...
      typedef unsigned long long int ADT_UInt40;  //64b
      typedef   signed long long int ADT_Int64;   //64b
      typedef unsigned long long int ADT_UInt64;   //64b
